...
class AppPageState<AppPage> extends State {
  ...
  Future<void> addContent() async {
    ...
    sb.write('App名称: ${await AppUtils_.getAppName()} \n');
    sb.write('App包名: ${await AppUtils_.getPackageName()} \n');
    sb.write('App版本名称: ${await AppUtils_.getVersionName()} \n');
    sb.write('App版本号: ${await AppUtils_.getVersionNumber()} \n');
    sb.write('App构建签名: ${await AppUtils_.getBuildSignature()} \n');
    sb.write('App安装商店: ${await AppUtils_.getInstallerStore()} \n');
